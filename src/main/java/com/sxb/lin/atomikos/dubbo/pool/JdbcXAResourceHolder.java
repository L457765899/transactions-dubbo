...
public class JdbcXAResourceHolder implements XAResourceHolder{

	private static final Logger LOGGER = LoggerFactory.getLogger(JdbcXAResourceHolder.class);
	...
	public JdbcXAResourceHolder(String dubboUniqueResourceName, 
